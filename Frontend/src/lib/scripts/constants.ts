export const BASE_PATH = import.meta.env.VITE_API_URL || "https://delitebotpanel.kermitcloud.space/"
export const INVITE_URL = import.meta.env.VITE_INVITE_URL || "https://discord.com/oauth2/authorize?client_id=1310688150838050818&permissions=8&integration_type=0&scope=bot"
